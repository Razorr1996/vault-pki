locals {
  ...
  test_org_v1_ica2_v1_chain = var.signed ? join("\n", [
    vault_pki_secret_backend_root_sign_intermediate.test_org_v1_sign_ica2_v1_by_ica1_v1[0].certificate,
    local.test_org_v1_ica1_v1_chain,
  ]) : ""
...
resource "vault_pki_secret_backend_intermediate_set_signed" "test_org_v1_ica2_v1_signed_cert" {
  ...
  depends_on = [
    vault_pki_secret_backend_root_sign_intermediate.test_org_v1_sign_ica2_v1_by_ica1_v1[0],
  ]
...
resource "vault_pki_secret_backend_role" "role" {
  depends_on = [
    vault_mount.test_org_v1_ica2_v1,
  ]
